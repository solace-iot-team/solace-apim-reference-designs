        ...
        apiProducts: {
            ...
            prodProducts: {
                ...
                safety: {
                  ...
                  displayName: 'Safety Production',
                  description: 'Safety Production API Product - requires approval',
              ...
              failure: {
                name: 'failure-production',
                displayName: 'Failure Production',
                description: 'Failure Production API Product - requires approval',
                approvalType: APIProduct.approvalType.MANUAL,
                apis: ['string'],
                permissions: [
                    { name: 'region_id', value: 'fr, de, it' },
...
bootstrapConfig.exposure.apiProducts.prodProducts.safety.apis = [bootstrapConfig.exposure.apis.apiSafety.name];
bootstrapConfig.exposure.apiProducts.prodProducts.failure.apis = [bootstrapConfig.exposure.apis.apiFailure.name];

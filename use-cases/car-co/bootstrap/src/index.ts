...
let bootstrapConfig = {
    ...
    // SOLACE_CLOUD_EVENT_PORTAL_URL: Helper.getMandatoryEnvVarValue('APIM_BOOTSTRAP_SOLACE_EVENT_PORTAL_API_URL'),
    // SOLACE_CLOUD_EVENT_PORTAL_TOKEN: Helper.getMandatoryEnvVarValue('APIM_BOOTSTRAP_SOLACE_EVENT_PORTAL_TOKEN'),

...
export APIM_BOOTSTRAP_CONNECTOR_SERVER_DOCKER_IMAGE="solaceiotteam/apim-connector-server:0.2.4"
export APIM_BOOTSTRAP_CONNECTOR_EVENT_PORTAL_APIS_PROXY_MODE="true"
...
export APIM_BOOTSTRAP_DEMO_PORTAL_SERVER_DOCKER_IMAGE="solaceiotteam/apim-demo-portal:0.1.18"

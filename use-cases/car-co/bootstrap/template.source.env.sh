...
export APIM_BOOTSTRAP_PLATFORM_API_SERVER_ORG_NAME="car-co"
export APIM_BOOTSTRAP_PLATFORM_API_SERVER_ORG_API_USER="car_co_admin"
export APIM_BOOTSTRAP_PLATFORM_API_SERVER_ORG_API_USER_PWD="car_co_admin_123!"
...
export APIM_BOOTSTRAP_PLATFORM_API_SERVER_DATA_VOLUME_MOUNT="$scriptDir/platform-api-server-data"
export APIM_BOOTSTRAP_PLATFORM_API_SERVER_FILE_USER_REGISTRY="organization_users.json"
env | grep APIM_BOOTSTRAP

# APIM SYSTEM SPECIFIC ENVIRONMENT
export APIM_SYSTEM_PROJECT_NAME=$APIM_BOOTSTRAP_USE_CASE_NAME
export APIM_SYSTEM_PLATFORM_API_SERVER_DATA_VOLUME_MOUNT=$APIM_BOOTSTRAP_PLATFORM_API_SERVER_DATA_VOLUME_MOUNT
export APIM_SYSTEM_PLATFORM_API_SERVER_FILE_USER_REGISTRY=$APIM_BOOTSTRAP_PLATFORM_API_SERVER_FILE_USER_REGISTRY

...
eventSchemaFile="$scriptDir/failure.schema.json"
payloadFile="$tmpDir/failure.payload.json"

# TOPICs
# `apim/car-co/api/V1/json/{region_id}/{make}/{model}/{vin}/{event_type}`
topics=(
  "apim/car-co/api/V1/json/fr/108/M2018/vin-0/failure"
  "apim/car-co/api/V1/json/fr/2008/MTPA/vin-1/failure"
  "apim/car-co/api/V1/json/fr/108/M2018/vin-2/failure"
  "apim/car-co/api/V1/json/fr/2008/MTPA/vin-3/failure"
  "apim/car-co/api/V1/json/de/108/M2018/vin-4/failure"
  "apim/car-co/api/V1/json/de/2008/MTPA/vin-5/failure"
  "apim/car-co/api/V1/json/de/108/M2018/vin-6/failure"
  "apim/car-co/api/V1/json/it/2008/MTPA/vin-7/failure"
  "apim/car-co/api/V1/json/it/108/M2018/vin-8/failure"
  "apim/car-co/api/V1/json/it/2008/MTPA/vin-9/failure"
)
...
for i in {1..2000}; do
    for topic in ${topics[@]}; do
      ...
      if [[ -z "$NO_RECORDING_SAMPLE_MESSAGES" ]]; then
        sampleMsgFileName="failure.payload.sample.$eventNum"
